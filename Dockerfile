...
# Install packages
RUN apt-get update
RUN apt-get install -y supervisor curl wget php5-fpm php5-mysql php5-mcrypt php5-gd php5-pgsql php5-mssql php5-ldap php5-memcached php5-curl php5-xdebug
